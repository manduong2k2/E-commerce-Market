...
class UpdateRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'code'          => ['string', 'max:255', 'nullable', Rule::unique('products', 'code')->ignore($this->route('product'))],
            'price'         => ['numeric', 'min:0', 'nullable'],
            'brandId'       => ['uuid', 'exists:brands,id', 'nullable'],
            'statusId'      => ['uuid', 'exists:brands,id', 'nullable'],
            ...
            'variants.*.id'             => ['uuid', 'max:255', 'nullable'],
            ...
            'variants.*.extraAttributes.*.id'       => ['uuid', 'max:255'],
